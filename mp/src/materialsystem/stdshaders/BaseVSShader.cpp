										...
										IShaderShadow* pShaderShadow, DrawFlashlight_dx90_Vars_t &vars )
{
	...
	if( pShaderShadow )
	{
		...
		if( vars.m_bLightmappedGeneric )
		{
			...
			{
				SDK_lightmappedgeneric_flashlight_vs30_Static_Index	vshIndex = SDK_lightmappedgeneric_flashlight_vs30_Static_Index(pShaderShadow, params);
			...
			{
				SDK_lightmappedgeneric_flashlight_vs20_Static_Index	vshIndex = SDK_lightmappedgeneric_flashlight_vs20_Static_Index(pShaderShadow, params);
				vshIndex.SetWORLDVERTEXTRANSITION( vars.m_bWorldVertexTransition );
				vshIndex.SetNORMALMAP( vars.m_bBump );
				vshIndex.SetSEAMLESS( bSeamless );
				vshIndex.SetDETAIL( bDetail );
		...
		if ( g_pHardwareConfig->SupportsShaderModel_3_0() && vars.m_bLightmappedGeneric )
		{
			...
			SDK_flashlight_ps30_Static_Index	pshIndex = SDK_flashlight_ps30_Static_Index(pShaderShadow, params);
		...
		else if ( g_pHardwareConfig->SupportsPixelShaders_2_b() )
		{
			...
			SDK_flashlight_ps20b_Static_Index	pshIndex = SDK_flashlight_ps20b_Static_Index(pShaderShadow, params);
			pshIndex.SetNORMALMAP( nBumpMapVariant );
			pshIndex.SetNORMALMAP2( bBump2 );
			pshIndex.SetWORLDVERTEXTRANSITION( vars.m_bWorldVertexTransition );
			pshIndex.SetSEAMLESS( bSeamless );
