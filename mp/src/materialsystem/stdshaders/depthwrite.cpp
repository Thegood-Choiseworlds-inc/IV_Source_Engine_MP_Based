	...
	SHADER_DRAW
	{
		...
		DYNAMIC_STATE
		{
...
#endif
			{
				SDK_depthwrite_vs20_Dynamic_Index vshIndex = SDK_depthwrite_vs20_Dynamic_Index(pShaderAPI);
			...
			else // 3.0 shader case (PC only)
			{
				...
				SDK_depthwrite_vs30_Dynamic_Index vshIndex = SDK_depthwrite_vs30_Dynamic_Index(pShaderAPI);
				vshIndex.SetSKINNING( pShaderAPI->GetCurrentNumBones() > 0 );
