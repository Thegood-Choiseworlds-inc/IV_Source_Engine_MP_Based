#ifndef _INCLUDED_POINT_DYNAMIC_LIGHT_H
#define _INCLUDED_POINT_DYNAMIC_LIGHT_H

class CPoint_Dynamic_Light : public CBaseEntity
{
public:
	DECLARE_CLASS(CPoint_Dynamic_Light, CBaseEntity);
...
#endif // _INCLUDED_POINT_DYNAMIC_LIGHT_H