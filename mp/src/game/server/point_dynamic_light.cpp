...
LINK_ENTITY_TO_CLASS(point_dynamic_light, CPoint_Dynamic_Light);

BEGIN_DATADESC(CPoint_Dynamic_Light)
...
IMPLEMENT_SERVERCLASS_ST(CPoint_Dynamic_Light, DT_Point_Dynamic_Light)
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CPoint_Dynamic_Light::KeyValue(const char *szKeyName, const char *szValue)
{
	...
	else if (FStrEq(szKeyName, "starton"))
	{
		m_On = atoi(szValue) == 1 ? true : false;
	}
	else
	{
...
//------------------------------------------------------------------------------
void CPoint_Dynamic_Light::InputTurnOn(inputdata_t &inputdata)
{
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CPoint_Dynamic_Light::InputTurnOff(inputdata_t &inputdata)
{
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CPoint_Dynamic_Light::InputToggle(inputdata_t &inputdata)
{
	if (m_On)
	{
...
// Purpose :
//------------------------------------------------------------------------------
void CPoint_Dynamic_Light::Spawn(void)
{
	Precache();
	SetSolid( SOLID_NONE );
	...
	{
		SetThink(&CPoint_Dynamic_Light::DynamicLightThink);
...
// Purpose: 
//-----------------------------------------------------------------------------
void CPoint_Dynamic_Light::DynamicLightThink(void)
{
	if ( m_target == NULL_STRING )
		return;
