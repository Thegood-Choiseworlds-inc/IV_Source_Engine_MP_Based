...
{
	if( muzzleflash_light_projected.GetBool() && m_flMuzzleFlashTime > gpGlobals->curtime )
		return true;
...
{
	m_flMuzzleFlashTime = gpGlobals->curtime + muzzleflash_light_projected_time.GetFloat();
}
