	...
	if (!m_Pick.bPicking)
	{
			...
			)
		{
				...
				(! g_pLPreviewOutputBitmap) )
			{
				...
				{
					Msg("Activating Light 3D Render Materials...\n");
					...
					Msg("Activating Light 3D Render Materials Done!!!\n");

					Msg("=============================================================\n");
					Msg("Checked '%s' Material with Shader '%s'\n", add_0_to_1->GetName(), add_0_to_1->GetShaderName());
					Msg("Checked '%s' Material with Shader '%s'\n", add_1_to_0->GetName(), add_1_to_0->GetShaderName());
					Msg("Checked '%s' Material with Shader '%s'\n", sample_last->GetName(), sample_last->GetShaderName());
					Msg("Checked '%s' Material with Shader '%s'\n", sample_other->GetName(), sample_other->GetShaderName());
					Msg("=============================================================\n");
				}
